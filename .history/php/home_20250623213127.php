...
// Suppression du code commenté inutile (ex: vérification de session)

// Ajout d'une fonction utilitaire pour simplifier les requêtes COUNT
...
// Récupération des totaux pour les statistiques avec la fonction getCount()
$data_users         = getCount($conn, "SELECT COUNT(*) AS total_users FROM users");
$data_reservations  = getCount($conn, "SELECT COUNT(*) AS total_reservations FROM reservation");
$data_salles        = getCount($conn, "SELECT COUNT(*) AS total_salles FROM salle");
$data_salles_available   = getCount($conn, "SELECT COUNT(*) AS available FROM salle WHERE disponibilite = 'disponible'");
$data_salles_unavailable = getCount($conn, "SELECT COUNT(*) AS unavailable FROM salle WHERE disponibilite != 'disponible'");
$data_notif         = getCount($conn, "SELECT COUNT(*) AS total_notif FROM reservation WHERE status = 'on'");
$data_signalements  = getCount($conn, "SELECT COUNT(*) AS total_signalements FROM service");
