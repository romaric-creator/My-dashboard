...
// Requêtes pour les tableaux et listes
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Non disponibles: <?php echo $stats['salles_indispo']; ?></p>
                        </div>
